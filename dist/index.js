...
>>>>>>> 7e3fb2f66a4220a71749943b6d87129c24acb755

	var _set2 = _interopRequireDefault(_set);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var _marked = [quips].map(_regenerator2.default.mark);
	...
	function fn1() {
		...
		try {
			for (var _iterator = (0, _getIterator3.default)(myarr), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		...
		try {
			for (var _iterator2 = (0, _getIterator3.default)("hello world"), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
		...
		var uniqueWords = new _set2.default(myarr);
		console.info(uniqueWords);
	};

	function quips(name) {
		return _regenerator2.default.wrap(function quips$(_context) {
			while (1) {
	...
	function testQuips() {
		var iter = quips("yicj");
		//这时候什么也没有返回
		console.info((0, _stringify2.default)(iter));

		var t1 = iter.next();

		console.info('t1 : ' + (0, _stringify2.default)(t1));

		var t2 = iter.next();

		console.info('t2 : ' + (0, _stringify2.default)(t2));

		var t3 = iter.next();

		console.info('t3 : ' + (0, _stringify2.default)(t3));

		var t4 = iter.next();

		console.info('t4 : ' + (0, _stringify2.default)(t4));
	}
...
>>>>>>> 7e3fb2f66a4220a71749943b6d87129c24acb755
	...
	function testQuips3() {
		...
		try {
			for (var _iterator3 = (0, _getIterator3.default)(iter), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
				var v = _step3.value;
